...
$(package)_patches=fix_qt_pkgconfig.patch mac-qmake.conf fix_configure_mac.patch fix_no_printer.patch fix-gcc13-limits.patch
...
define $(package)_preprocess_cmds
  sed -i 's/#if defined(Q_CC_MINGW) || !defined(TOUCHEVENTF_MOVE)/#if !defined(TOUCHEVENTF_MOVE)/' qtbase/src/plugins/platforms/windows/qwindowsmousehandler.cpp && \
  patch -p1 < $($(package)_patch_dir)/fix-gcc13-limits.patch && \
