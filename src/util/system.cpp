...
const char * const BITCOIN_CONF_FILENAME = "lumenite.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lumenite";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Lumenite";
#else
    // Unix-like
    return pathRet / ".lumenite";
#endif
#endif
}
