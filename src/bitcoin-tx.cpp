...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lumenite-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lumenite-tx [options] <hex-tx> [commands]  Update hex-encoded Lumenite transaction\n" +
            "or:     lumenite-tx [options] -create [commands]   Create hex-encoded Lumenite transaction\n" +
            "\n";
